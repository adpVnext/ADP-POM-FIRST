...
onDeviceReady: function() {
    ...
    appp.fetch (
                ...
                result = result + '/';
                console.log('appp.fetchUrl: ' + result);
                configUrl = result;
...
//                                                        console.log("1/Level2SecurityInfo success: ");
//                                                        console.log("2/Level2SecurityInfo" + result);
                                                        
                                                        if  (result==null) {
//                                                            console.log("3/Level2SecurityInfo result==null");
                                                            receivedElement.innerHTML  = "Veuillez vous authentifier à l'aide du menu ci-dessus";
                                                        } else {
//                                                            console.log("4/Level2SecurityInfo result <> null");
                                                            if(navigator.onLine)
                                                            {
                                                    ...
                                                    function(result) {
                                                        ...
                                                        var receivedElement = parentElement.querySelector('.received');
                                                        console.log(result);
//                                                        console.log ("5/Level2SecurityInfo " + result );
